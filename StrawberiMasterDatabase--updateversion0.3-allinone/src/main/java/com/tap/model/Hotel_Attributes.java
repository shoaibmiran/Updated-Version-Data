...
public class Hotel_Attributes {
	...
	private String list_of_offers = null;
	...
	private ArrayList<Hotel_Special_Event> special_event = null;

	/*public Hotel_Attributes(String item, String description, String number_of_days, String number_of_nights,
			...
			String list_of_offers, String season, String continent, String country, String state, String theme,
			String tags, ArrayList<Hotel_Special_Event> special_event) {
		this.item = item;
		...
		this.list_of_offers = list_of_offers;
		this.season = season;
	...
	public Hotel_Attributes(String item, String number_of_days, String number_of_nights,
			 String created_by, String continent,
	...
	public String getList_of_offers() {
		return list_of_offers;
	}

	public void setList_of_offers(String list_of_offers) {
		this.list_of_offers = list_of_offers;
	}
	...
	public ArrayList<Hotel_Special_Event> getSpecial_event() {
		return special_event;
	}

	public void setSpecial_event(ArrayList<Hotel_Special_Event> special_event) {
		this.special_event = special_event;
	}

	public Hotel_Attributes() {
		super();
